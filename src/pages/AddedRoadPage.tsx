  ...
  return (
    <Layout>
      {isLoading ? (
        ...
        <div className="px-4">
          <div className="flex flex-row justify-between items-center bg-[#F9F9F9] p-6 mb-4">
          ...
          <div className="flex flex-col rounded-20 p-4 mb-4">
            ...
            <p className="text-[14px] mb-4">{data?.id}</p>
            <Button onClick={() => {}}>Добавить в календарь</Button>
          </div>
          <div className="flex flex-col rounded-20 p-4 mb-4">
            <div className="flex flex-row justify-between items-center">
              <p className="text-[20px] font-bold">Начисление бонусов</p>
              <div className="flex flex-row items-center gap-1 justify-center rounded-8 p-[6px]">
                <span>+ 125</span>
                <UnionIcon />
              </div>
            </div>
